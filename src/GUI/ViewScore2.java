...
//Updating Texts
			...
			if(play_brain2.if_second_inning_over && (play_brain1.team_score_1<play_brain2.team_score_2)){
				if(toss_brain.userselect.equals("bat"))
				{
					comm.setText(Single_player.oppteam+" Wins");
				}
				else
					comm.setText(Single_player.myteam+" Wins ");
			}
			else if(play_brain2.if_second_inning_over && (play_brain1.team_score_1>play_brain2.team_score_2)){
				if(toss_brain.userselect.equals("bat"))
				{
					comm.setText(Single_player.myteam+" Wins");
				}
...
//Exit Button
			...
			end.setBounds((int) (Single_player.screenSize.width/(2)),(int) (Single_player.screenSize.height/(1.2)),(int) (Single_player.screenSize.width/6), Single_player.screenSize.height/10);
			end.setBorderPainted(true);
			end.setFont(Single_player.fbutton);
