...
public static  ImageIcon imageIcon;
	...
	static Font flabel=new Font("Georgia",Font.BOLD,75);
	static Font flist=new Font("Comic Sans MS",Font.BOLD,40);
	static Font fsmalllabel=new Font("Comic Sans MS",Font.BOLD,60);
	static Color clist;
